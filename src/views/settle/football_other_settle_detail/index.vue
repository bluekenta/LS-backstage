        ...
        >
          ...
          <template #operaction="{ row }">
            <template v-if="row.settleStatus === 0">
              <el-button
                v-if="hasAuth('MANUALSETTLESPECIAL')"
            ...
            <template v-else>
              ...
              <div v-else>
                <el-button
                  size="small"
                  v-if="row.isEdit === false && hasAuth('RESETTLESPECIAL')"
...
import { useOtherFootballSettlement } from './utils/hook';
